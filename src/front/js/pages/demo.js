		...
		<div id="loginFormAndPhoto" >
			...
			<form style={{ width: "50%", margin: "10px", display: "flex", flexDirection: "column" }}>
				...
				<div className="form-check">
					<input className="form-check-input" type="checkbox" id="flexCheckIndeterminate"></input>
				...
				<div style={{display: "flex", justifyContent: "space-between"}}>
					<Link to='/formForgotPassword'> <div style={{ marginTop: "20px" }}>ForgotPassword?</div></Link>
					<Link to='/formSignup'><div style={{ marginTop: "20px" }}>Don't have an account? Sign Up</div></Link>
				</div>
			</form>
